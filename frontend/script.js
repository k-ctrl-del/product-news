...
const API_BASE = ""; // relative to current origin; adjust if backend hosted separately
...
function renderArticles(articles) {
  ...
  articles.forEach((article) => {
    ...
    const published = article.published ? new Date(article.published).toLocaleString() : "";
